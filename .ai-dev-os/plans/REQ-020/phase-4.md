...
8. Phase 4 的受控入口使用仓库外固定 GitHub CLI 调度 main 上的 OIDC attestor，以唯一 request ID 定位 run、下载 attested artifact，并在每次 Gate 重验时重新核验 Sigstore 与 GitHub 实时事实；重验不得重复执行 workflow。
