...
$policy = @{
    ...
    runner_sha256 = "1198cf4e1526983e4a959d29620e0250381b4d82397710bef52044233387871f"
    attestor_policy_path = ".github/phase-4-attestation-policy.json"
    attestor_policy_fingerprint = "eea7d1beee2fe504f1d3ce1f3f786fe5b8581325200baec7bbd64771aef9cbd8"
